---
title: "Hazle Terms of Service"
pageType: terms
projectSlug: hazle
---

These terms and conditions apply to the Hazle app (hereby referred to as "Application") for mobile devices that was
created by Tashila Pathum (hereby referred to as "Service Provider") as an Open Source service.
...
* **OpenAI:** By using our chat features, you agree to OpenAI’s processing of your prompts. While we redact sensitive
information locally, your data is subject to [OpenAI’s Terms of Service](https://openai.com/policies/terms-of-use).
* **Supabase:** User authentication and account data management are provided by Supabase. Your account usage is governed
by the [Supabase Terms of Service](https://supabase.com/terms).
* **Sentry:** We use Sentry to monitor application performance and stability. By using the app, you acknowledge Sentry’s
role in error tracking as outlined in the [Sentry Terms of Service](https://sentry.io/terms/).
...
The Application incorporates Artificial Intelligence (AI) technologies to provide certain features or services. By using
the Application, you acknowledge and agree that AI may be used to process data and deliver functionalities. The Service
Provider ensures that all AI usage complies with applicable laws and is designed to benefit the user experience.
...
application to) may change, and you will need to download the updates if you want to continue using the application.
The Service Provider does not guarantee that it will always update the application so that it is relevant to you and/or
...
Provider at tashila.pathum@gmail.com.
