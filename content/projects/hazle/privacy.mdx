---
title: "Hazle Privacy Policy"
pageType: privacy
projectSlug: hazle
---

This privacy policy is applicable to the Hazle app (hereinafter referred to as "Application") for mobile devices, which
was developed by Tashila Pathum (hereinafter referred to as "Service Provider") as a an Open Source service. This
...
All AI processing is performed in accordance with this privacy policy and applicable laws, ensuring your data is handled
...
* **OpenAI:** Processes your chat prompts. We redact sensitive information locally before transmission. [OpenAI Privacy Policy](https://openai.com/policies/privacy-policy)
* **Supabase:** Handles user authentication and account storage. [Supabase Privacy Policy](https://supabase.com/privacy)
* **Sentry:** Monitors app performance and crashes. [Sentry Privacy Policy](https://sentry.io/privacy/)
...
*   with their trusted services providers who work on their behalf, do not have an independent use of the information
we disclose to them, and have agreed to adhere to the rules set forth in this privacy statement.
...
Application, please contact them at tashila.pathum@gmail.com and we will respond in a reasonable time. Please note that
some or all of the User Provided Data may be required in order for the Application to function properly.
...
under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If
you are a parent or guardian and you are aware that your child has provided us with personal information, please contact
the Service Provider (tashila.pathum@gmail.com) so that they will be able to take the necessary actions.
...
we limit access to this information to authorized employees and contractors who need to know that information in order
to operate, develop or improve their Application. Please be aware that, although we endeavor provide reasonable security
...
contact the Service Provider via email at tashila.pathum@gmail.com.
