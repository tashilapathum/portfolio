...
image: "/projects/one-finance-showcase.png"
featured: 3
tagline: "One app for money, bills, bank accounts, loans and investments — offline, and fast enough to use at the till."
role: "Solo — design and app"
facts:
  - label: "Role"
    value: "Solo — design and app"
  - label: "Core interaction"
    value: "Add a transaction in two taps"
  - label: "Data"
    value: "Offline-first, on-device only"
  - label: "Scope"
    value: "Wallet, accounts, investments, reports, tools"
specs:
  - label: "Stack"
    value: "Kotlin · Jetpack Compose · Room"
  - label: "Model"
    value: "One wallet, many accounts — mirrors real life"
  - label: "Reporting"
    value: "Daily, weekly and monthly, with category pie chart"
  - label: "Tools"
    value: "Shopping cart, bills, loans, calculator, quick list"
notes:
  - title: "Two taps, or it fails"
    body: "The whole wallet screen is built around logging an expense before you have put your change away — categories are optional and can be set later."
  - title: "One wallet, many accounts"
    body: "Most finance apps model several wallets. You only have one physical wallet, so the balance on the main page is that wallet; bank accounts are separate."
  - title: "Categories are opt-in"
    body: "Deciding a category is friction at the moment of purchase, so it is deferrable — with a built-in colour picker and per-category spend in a pie chart."
  - title: "Bills that reach you"
    body: "Bills can be written to the device calendar when added, so the reminder lives where the user already looks."
---
